...
<tbody>
<?php $i=1; foreach($absen_guru as $absen_guru)
{
?>
<tr>
<td><?php echo $i++ ?></td>
...
<td>
<a href="<?php echo site_url('absen/edit_guru2/'.$absen->id_absenguru)?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
<?php
include('delete_absenguru.php');
?>
</td>
</tr>
<?php } ?>
