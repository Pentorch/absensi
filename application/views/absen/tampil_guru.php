...
<?php echo form_open("absen/guru/".$this->session->userdata('username'));?>
<div class="col-md-6">
    <div class="form-group">
...
echo form_open_multipart(site_url('absen/simpan_guru'));
?>
	<?php if(
		$this->session->userdata('username') == $this->uri->segment(3)
		):?>
