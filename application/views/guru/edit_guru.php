...
echo form_open_multipart(site_url('guru/edit/'.$guru->id_guru));
?>
<div class="row">
                <div class="col-lg-12">
       ...
       <form role="form">
            ...
            <div class="form-group">
            <label>Foto</label>
             <input type="file" name="foto" class="form_control" value="<?php echo $guru->foto ?>"><?php echo $guru->foto ?></input>
            </div>
            <div class="form-group">
            <label>Alamat</label>
