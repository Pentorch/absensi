...
echo form_open_multipart(site_url('guru/lihat_wk/'.$guru->id_guru));
?>
...
<div class="row">
                ...
                <!-- /.col-lg-12 -->
<p> <a href="<?php echo site_url('guru/edit_wk/'.$guru->nip)?>" class="btn btn-primary btn-sm" title="Edit"><i class="fa fa-plus"></i> Edit</a> </p>
<!-- /.row -->
<div class="col-lg-8">
       <form role="form">
