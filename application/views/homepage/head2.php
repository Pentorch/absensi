...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('homepage/piket')?>">SMKN 1 Sintoga</a>
            </div>      
            </div>
            <!-- /.navbar-top-links -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('homepage/piket')?>"><i class="fa fa-institution fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <li>
                                <a href="<?php echo site_url('jadwal/tampil2') ?>"><i class="fa fa-calendar fa-fw"></i>Daftar Jadwal</a>
                        </li>
                            <li>
                                <a href="<?php echo site_url('guru/guru2') ?>"><i class="fa fa-group fa-fw"></i>Absen Guru</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('absen/lihat_guru2') ?>"><i class="fa fa-book fa-fw"></i>Data Absen Guru</a>
                            </li>
                    </li>
                            <li>
                                <a href="<?php echo site_url('siswa/tampil2') ?>"><i class="fa fa-group fa-fw"></i>Absen Siswa</a>
                            </li>
                    </li>
                    <li>
                                <a href="<?php echo site_url('absen/piket') ?>"><i class="fa fa-book fa-fw"></i>Data Absen Siswa</a>
                            </li>
                    <li>
                        ...
                        <ul id="rekap" class="nav nav-second-level">
                            <li>
                                <a href="<?php echo site_url('rekap/guru2') ?>">Rekap Harian Guru</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('rekap/piket') ?>">Rekap Absen Guru</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('rekap/siswa2') ?>">Rekap Harian Siswa</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('absen/coba2') ?>">Rekap Absen Siswa</a>
                            </li>
                        </ul>
                    </li>
                </div>
