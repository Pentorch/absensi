            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo site_url('homepage/guru')?>"><i class="fa fa-institution fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('guru/lihat_gr/'.$this->session->userdata('username'))?>"><i class="fa fa-user fa-fw"></i> Profil</a>
                        </li>
                        <li>
                                <a href="<?php echo site_url('jadwal/tampil_a/'.$this->session->userdata('username')) ?>"><i class="fa fa-calendar fa-fw"></i> Daftar Jadwal</a>
                        </li>
                        <li>
                                <a href="<?php echo site_url('absen/tampil_a') ?>"><i class="fa  fa-group fa-fw"></i> Absen Siswa</a>
                        </li>
                        <li>
                                <a href="<?php echo site_url('absen/coba_a/'.$this->session->userdata('username')) ?>"><i class="fa  fa-group fa-fw"></i>Rekap Absen Siswa</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url('rekap/detail_a/'.$this->session->userdata('username'))?>"><i class="fa fa-user fa-fw"></i>Absen Saya</a>
                        </li>
                    </ul>
            </div>
                <!-- /.sidebar-collapse -->
