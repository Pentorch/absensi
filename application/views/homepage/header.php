...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('homepage')?>">SMKN 1 Sintoga</a>
            </div>      
            </div>
            <!-- /.navbar-top-links -->
...
<li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo site_url('homepage/edit/'.$this->session->userdata('id_user'))?>"><i class="fa fa-user fa-fw"></i>Ganti Password</a>
                        </li>
                        <li class="divider"></li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo site_url('homepage')?>"><i class="fa fa-institution fa-fw"></i> Home</a>
                        </li>
                        
                        <li>
                            <a href="<?php echo site_url('user') ?>"><i class="fa fa-android fa-fw"></i> User</a>
                        </li>
                        <li>
                        <a href="#"><i class="fa fa-mortar-board fa-fw"></i>Guru<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <ul id="Guru" class="nav nav-second-level">
                            <li>
                                <a href="<?php echo site_url('guru') ?>">Data Guru</a>
                            </li>
                            <!-- <li>
                                <a href="<?php echo site_url('absen/guru') ?>">Absen Guru</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('rekap/guru') ?>">Rekap Harian</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('absen/lihat_guru') ?>">Data Absen Guru</a>
                            </li> -->
                        </ul>
                    </ul>
                    </li>
                        ...
                        <ul id="Siswa" class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo site_url('jadwal/chain') ?>">Absen Siswa</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('absen') ?>">Data Absen Siswa</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('rekap/siswa') ?>">Rekap Harian</a>
                            </li>
                        </ul>
                    </ul>
                    </li>
                    <li>
                        ...
                        <ul id="Siswa" class="nav nav-second-level">
                            <li>
                                <a href="<?php echo site_url('jadwal') ?>">Jam Pelajaran</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('jadwal/lihat_mapel') ?>">Mata Pelajaran</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('jadwal/jadwal') ?>">Jadwal Pelajaran</a>
                            </li>
                        </ul>
                    </ul>
                    </li>
                    <li>
                        <a href="<?php echo site_url('kelas') ?>"><i class="fa fa-cubes fa-fw"></i> Kelas</a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('jurusan') ?>"><i class="fa fa-cubes fa-fw"></i> Jurusan</a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('sem') ?>"><i class="fa  fa-play-circle fa-fw "></i> Semester</a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="rekap" class="nav nav-second-level">
                            <li>
                                <a href="<?php echo site_url('rekap') ?>">Absen Guru</a>
                            </li>
                            <li>
                                <a href="<?php echo site_url('absen/coba') ?>">Absen Siswa</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <a href="<?php echo site_url('siswa/test') ?>"><i class="fa  fa-play-circle fa-fw "></i>Testing</a>
                    </li>
