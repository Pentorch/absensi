...
echo form_open_multipart(site_url('kelas/edit/'.$kelas->id_kelas));
?>
<div class="row">
                <div class="col-lg-12">
       ...
       <form role="form">
            ...
            <label>Nama Kelas</label>
             <input class="form-control" placeholder="Nama Kelas" name="kelas" value="<?php echo $kelas->kelas ?>" required>
            </div>
            <div class="form-group">
            <label>Jurusan</label>
            <select class="form-control" name="id_jur">
             <?php foreach ($jur as $jur) { ?>
                 ...
                 <?php if($kelas->id_jur == $jur->id_jur){ echo "selected";}?> >
            ...
            <select class="form-control" name="id_guru">
             <?php foreach ($guru as $guru) { ?>
                 ...
                 <?php if($kelas->id_guru == $guru->id_guru){ echo "selected";}?> >
